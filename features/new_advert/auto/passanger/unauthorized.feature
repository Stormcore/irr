...
@advert_submit
  Сценарий: Подача объявления неавторизированным пользователем
    ...
    Когда я выхожу из текущего пользователя
        ...
        * в ЛК ИП объявление с названием "Audi A1, кабриолет, 2001 г. в., пробег: 30000 км., автоматическая, 2.6 л" присутствует в списке
...
@advert_submit
  Сценарий: Проверка деталей поданного объявления
    Когда я вхожу под пользователем с ролью "Доверенный интернет-партнер 9"
       ...
       То в ЛК ИП объявление с названием "Audi A1, кабриолет, 2001 г. в., пробег: 30000 км., автоматическая, 2.6 л" присутствует в списке
    ...
    Когда я открываю детали этого объявления
        ...
        * на вкладке "Все" "Пробег" равно "30000 км"
        * на вкладке "Все" "Мощность двигателя" равно "200 л.с."
        * на вкладке "Все" "Объем двигателя" равно "2.6 л"
