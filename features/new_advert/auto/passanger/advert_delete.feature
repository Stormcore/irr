...
@advert_submit
  Сценарий: Проверка деталей поданного объявления
    Когда я вхожу под пользователем с ролью "Доверенный интернет-партнер"
       ...
       То объявление с названием "Audi A8,  кабриолет,  2008 г. в.,  автоматическая" присутствует в списке

    Когда я удаляю данное объявление
       То объявление с названием "Audi A8,  кабриолет,  2008 г. в.,  автоматическая" отсутствует в списке
