...
@advert_submit
  Сценарий: Подача премиума через БО
    Когда я перехожу на БО
        ...
        * на странице создания нового премиума в БО я выбираю категорию "Авто и мото -> Легковые автомобили -> Автомобили с пробегом -> авто с пробегом"
        * при создании премиума я ввожу следующие данные:
          ...
          | Объем двигателя      | 2.6            |
          | Текст объявления     | Тест подачи объявления неавторизированным пользователем |
        ...
        * при создании премиума я загружаю картинку
        * я сохраняю введенный премиум
