...
Контекст:
  ...
  Структура сценария: Добавление пакетов Недвижимости
        * на БО я ищу пользователя с ролью "<роль>"
        * на БО я открываю детали интернет-партнера
        * на БО я удаляю все пакеты "NEW Недвижимость | ВСЕ РЕГИОНЫ"
  ...
  Структура сценария: Добавление пакетов Авто
        * на БО я ищу пользователя с ролью "<роль>"
        * на БО я открываю детали интернет-партнера
        * на БО я удаляю все пакеты "NEW Авто | ВСЕ РЕГИОНЫ"
