...
@new_advert
  Сценарий: Подача объявления неавторизированным пользователем
   Когда я выхожу из текущего пользователя
      ...
      То объявление с названием "1-комн.  квартира,  Пушкинский р-н,  Пушкино ,   Строительная ул,  4/8,  площадь:  общая 80 кв. м.,  жилая 50 кв. м.,  кухня 20 кв. м.,  с/у раздельный,  типовой,  городской телефон,  мебель,  бытовая техника" присутствует в списке
...
@after_index
  Сценарий: Проверка создания объявления
   Когда на главной странице я перехожу в категорию "Недвижимость -> Квартиры. Аренда"
       ...
       * в списке обычных объявлений присутствует объявление "1-комн.  квартира,  Пушкинский р-н,  Пушкино ,   Строительная ул,  4/8,  площадь:  общая 80 кв. м.,  жилая 50 кв. м.,  кухня 20 кв. м.,  с/у раздельный,  типовой,  городской телефон,  мебель,  бытовая техника"
