# language:ru
# encoding: utf-8
Функционал: Недвижимость -> Квартиры. Продажа -> Новостройки - подача объявлений в регионы
...
@new_advert
  Сценарий: Подача объявления неавторизированным пользователем
   Когда я выхожу из текущего пользователя
      ...
      То объявление с названием "1-комн.  квартира,  Осинский р-н,  Усть-Алтан с,  4/8,  площадь:  общая 80 кв. м.,  жилая 50 кв. м.,  кухня 20 кв. м.,  с/у раздельный,  типовой,  балкон/лоджия,  городской телефон" присутствует в списке
...
@after_index
  Сценарий: Проверка создания объявления
   Когда открыта страница для региона "Усть-Алтан"
       ...
       * в списке обычных объявлений присутствует объявление "1-комн.  квартира,  Осинский р-н,  Усть-Алтан с,  4/8,  площадь:  общая 80 кв. м.,  жилая 50 кв. м.,  кухня 20 кв. м.,  с/у раздельный,  типовой,  балкон/лоджия,  городской телефон"
