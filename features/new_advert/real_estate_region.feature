...
@new_advert
  Сценарий: Подача объявления неавторизированным пользователем
   Когда я выхожу из текущего пользователя
      ...
      То объявление с названием "1-комн. кв.,  Осинский р-н,  Усть-Алтан с,  4/8,  площадь:  общая 80 кв. м.,  жилая 50 кв. м.,  кухня 20 кв. м.,  с/у раздельный,  с отделкой,  балкон/лоджия,  городской телефон" присутствует в списке
