...
@after_index
  Сценарий: Проверка индексации объявления - поиск по району
    Когда на главной странице я перехожу в категорию "Недвижимость -> Квартиры. Продажа -> Новостройки"
       ...
       * в списке обычных объявлений присутствует объявление "3-комн. кв.,  3,  площадь:  общая 300 кв. м."
       * в списке обычных объявлений объявление "3-комн. кв.,  3,  площадь:  общая 300 кв. м." выделено
