...
@advert_submit
  Сценарий: Проверка деталей поданного объявления
    Когда я вхожу под пользователем с ролью "Доверенный интернет-партнер"
       ...
       То объявление с названием "9-комн. кв.,  9,  площадь:  общая 900 кв. м." присутствует в списке

    Когда я удаляю данное объявление
       То объявление с названием "9-комн. кв.,  9,  площадь:  общая 900 кв. м." отсутствует в списке
