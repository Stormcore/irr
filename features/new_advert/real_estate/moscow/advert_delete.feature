# language:ru
# encoding: utf-8
Функционал: Удаление объявления - Недвижимость -> Вторичная недвижимость (Москва)
...
@advert_submit
  Сценарий: Проверка деталей поданного объявления
    ...
    Когда в ЛК ИП я запоминаю значение счетчика для категории "Недвижимость -> Квартиры. Продажа -> Вторичная недвижимость"
        ...
        * в ЛК ИП счетчик для категории "Недвижимость -> Квартиры. Продажа -> Вторичная недвижимость" уменьшился на 1
