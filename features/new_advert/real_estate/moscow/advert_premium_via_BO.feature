# language:ru
# encoding: utf-8
Функционал: Создание премиума через БО - Недвижимость -> Вторичная недвижимость (Москва)
...
@advert_submit
  Сценарий: Создание премиума через БО
   ...
   Когда я перехожу на БО
       ...
       * на странице дерева объявлений в БО я выбираю категорию "Недвижимость -> Квартиры. Продажа -> Вторичная недвижимость -> Квартиры продажа"
...
@after_index
  Сценарий: Проверка индексации
   Когда открыта страница для города "Москва"
       * на главной странице я перехожу в категорию "Недвижимость -> Квартиры. Продажа -> Вторичная недвижимость"
