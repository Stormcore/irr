...
Функционал: Импорт в категорию Авто и мото -> Выкуп автомобилей. Спрос
  ...
  Сценарий: Импорт объявления ОП
    ...
    Когда я открываю детали этого объявления
        * на вкладке "Все" "Тип автомобиля" равно "легковой"
        * на вкладке "Все" "Состояние" равно "битая"
        * на вкладке "Все" "Автомобили" равно "русские"
  ...
  Сценарий: Импорт объявления с фото
    Когда я обновляю и импортирую файл "cars_repayment/scenario3.xml" для роли "Доверенный интернет-партнер"
