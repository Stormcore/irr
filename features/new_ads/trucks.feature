...
Функционал: Проверка необходимых полей в Грузовиках
  ...
  Сценарий: Подача объявления с необходимыми полями
    ...
    Когда на странице выбора региона и категории я ввожу следующие данные:
        ...
        * в списке объявлений присутствует объявление с заголовком "Chevrolet Kodiak грузовик бортовой"
    ...
    Когда я открываю детали выбранного объявления
        ...
        * в деталях объявления указаны следующие данные:
          ...
          | Рубрика         | Грузовики                          |
          | Регион          | Москва                             |
          | Заголовок       | Chevrolet Kodiak грузовик бортовой |
          | Тип кузова      | грузовик бортовой                  |
