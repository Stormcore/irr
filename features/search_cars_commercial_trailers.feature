...
Функционал: Авто и мото -> Коммерческий транспорт -> Грузовые прицепы
  ...
  Сценарий: Фильтр по марке и модели
   Когда открыта страница для города "Москва"
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Марка" равно "Nooteboom"
       И в деталях каждого объявления "Модель" равно "BV 3LSDU1827"
  ...
  Сценарий: Фильтр по пробегу
   Когда открыта страница для города "Москва"
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Число осей" равно "4"
