...
Функционал: Товары для детей -> Детская обувь - seo-линки
  ...
  Сценарий: Фильтр по детским ботинкам
    Когда я выбираю ссылку "Детские ботинки" в секции "Быстрый поиск"
        ...
        * поле "Ключевые слова" равно "ботинки"
