# language:ru
# encoding: utf-8
Функционал: Услуги и деятельность -> Строительные и ремонтные услуги -> Cтроительно-монтажные работы - seo-линки

  Контекст:
    Когда открыта страница для города "Москва"
        * на главной странице я перехожу в категорию "Услуги и деятельность -> Строительные и ремонтные услуги -> Cтроительно-монтажные работы"
  ...
  Сценарий: Фильтр по земляным работам
    Когда я выбираю ссылку "Земляные работы: бурение колодцев, скважен" в секции "Быстрый поиск"
        ...
        * в поле "Вид услуги" выбраны следующие значения:
          | value                                      |
          | земляные работы, бурение колодцев, скважен |
