...
Функционал: Недвижимость - Дома, дачи и участки. Продажа - Участки - seo-линки
  ...
  Сценарий: Фильтр по 4 соткам
    Когда я выбираю ссылку "4 сотки" в секции "Быстрый поиск"
        ...
        * значение в поле "Площадь участка, сотки" равно от 4
        * значение в поле "Площадь участка, сотки" равно до 4

  Сценарий: Фильтр по 6 соткам
    Когда я выбираю ссылку "6 сотки" в секции "Быстрый поиск"
       То ссылка содержит "6sotki"
        * значение в поле "Площадь участка, сотки" равно от 6
        * значение в поле "Площадь участка, сотки" равно до 6

  Сценарий: Фильтр по 8 соткам
    Когда я выбираю ссылку "8 сотки" в секции "Быстрый поиск"
       То ссылка содержит "8sotki"
        * значение в поле "Площадь участка, сотки" равно от 8
        * значение в поле "Площадь участка, сотки" равно до 8

  Сценарий: Фильтр по 10 соткам
    Когда я выбираю ссылку "10 сотки" в секции "Быстрый поиск"
       То ссылка содержит "10sotki"
        * значение в поле "Площадь участка, сотки" равно от 10
        * значение в поле "Площадь участка, сотки" равно до 10

  Сценарий: Фильтр по 15 соткам
    Когда я выбираю ссылку "15 сотки" в секции "Быстрый поиск"
       То ссылка содержит "15sotki"
        * значение в поле "Площадь участка, сотки" равно от 15
        * значение в поле "Площадь участка, сотки" равно до 15
