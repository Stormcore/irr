# language:ru
@failing
Функционал: Авто и мото -> Автосервис и услуги -> Эскпертиза и оценка

  Сценарий: Все результаты
   Когда открыта страница для города "Москва"
       И на главной странице я перехожу в категорию "Авто и мото -> Автосервис и услуги -> Эскпертиза и оценка" 
