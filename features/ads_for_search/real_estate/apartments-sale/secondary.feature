# language:ru
# encoding: utf-8
Функционал: Недвижимость -> Квартиры. Продажа -> Вторичная недвижимость

  Сценарий: Объявление 1 - Москва
   Когда открыта страница для города "Москва"
       * я вхожу под пользователем с ролью "Доверенный интернет-партнер"
       * я подаю объявление в категорию "Недвижимость -> Квартиры. Продажа -> Вторичная недвижимость" с параметрами:
          | parameter                  | value            |
