# language:ru
# encoding: utf-8
Функционал: Телефоны и связь -> Фото, оптика -> Фототехника -> Вспышки

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Телефоны и связь -> Фото, оптика -> Фототехника -> Вспышки"
