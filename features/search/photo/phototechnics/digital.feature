# language:ru
# encoding: utf-8
Функционал: Телефоны и связь -> Фото, оптика -> Фототехника -> Фотоаппараты цифровые

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Телефоны и связь -> Фото, оптика -> Фототехника -> Фотоаппараты цифровые"
  ...
  Сценарий: Фильтр по количеству мегапикселей
   Когда я делаю поиск по следующим параметрам:
      | parameter                       | min | max |
      | Количество мегапикселей матрицы | 1   | 20  |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Количество мегапикселей матрицы" >= "1"
       И в деталях первого объявления "Количество мегапикселей матрицы" <= "20"
