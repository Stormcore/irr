...
Функционал: Электроника и техника -> Техника для авто -> Автомойки
  ...
  Сценарий: Фильтр по производительности
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Производительности" <= "1"
       И в деталях первого объявления "Производительности" => "100"
  ...
  Сценарий: Фильтр по давлению
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Давление" <= "1"
       И в деталях первого объявления "Давление" => "1000"
