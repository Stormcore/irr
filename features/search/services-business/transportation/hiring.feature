...
@customfield
  Сценарий: Фильтр по назначению
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Назначение" равно "свадьбы"
...
@customfield
  Сценарий: Фильтр по количеству мест
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Количество мест" >= "1"
       И в деталях первого объявления "Количество мест" <= "4"
...
@customfield
  Сценарий: Фильтр по дополнительным опциям
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Доп. опции" равно "кондиционер"
