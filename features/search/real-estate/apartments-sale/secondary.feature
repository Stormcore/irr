...
@empty_results
  Сценарий: Фильтр по приватизированной квартире
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Приватизированная квартира"
  ...
  Сценарий: Фильтр по отделке
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Отделка" равно "с отделкой"
  ...
  Сценарий: Фильтр по балкону\лоджии
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Балкон/Лоджия"
