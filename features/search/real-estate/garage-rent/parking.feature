# language:ru
Функционал: Недвижимость -> Гаражи и стоянки. Аренда -> Гаражи и боксы

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Недвижимость -> Гаражи и стоянки. Аренда -> Гаражи и боксы"
  ...
  Сценарий: Фильтр по типу гаража
    Когда я делаю поиск по следующим параметрам:
      | parameter  | value    |
      | Тип гаража | закрытая |
      И на странице поиска загружен список результатов для недвижимости
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип гаража" равно "бокс"
  ...
  Сценарий: Фильтр по машиноместу
    Когда я делаю поиск по следующим параметрам:
      | parameter  | value |
      | Машиномест | 1     |
      И на странице поиска загружен список результатов для недвижимости
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Машиномест" равно "1"
