...
Функционал: Недвижимость -> Квартиры. Аренда
  ...
  Сценарий: Фильтр по комнатам в квартире
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Комнат в квартире" равно "3"
  ...
  Сценарий: Фильтр по общей площади
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Общая площадь" >= "10"
       И в деталях каждого объявления "Общая площадь" <= "300"
  ...
  Сценарий: Фильтр по жилой площади 
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Жилая площадь" >= "10"
       И в деталях каждого объявления "Жилая площадь" <= "300"
  ...
  Сценарий: Фильтр по площади кухни 
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Площадь кухни" >= "10"
       И в деталях каждого объявления "Площадь кухни" <= "300"
...
@bugs @bug33726
  Сценарий: Фильтр по этажу
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления этаж не первый
  ...
  Сценарий: Фильтр по ремонту
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Ремонт" равно "евроремонт"
  ...
  Сценарий: Фильтр по лифтам в здании
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Лифты в здании"
