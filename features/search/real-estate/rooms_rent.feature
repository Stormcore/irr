...
Функционал: Недвижимость -> Комнаты. Аренда
  ...
  Сценарий: Фильтр по комнатам в квартире
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Комнат сдается" равно "3"
  ...
  Сценарий: Фильтр по площади арендуемой комнаты
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Площадь арендуемой комнаты" >= "10"
       И в деталях каждого объявления "Площадь арендуемой комнаты" <= "300"
