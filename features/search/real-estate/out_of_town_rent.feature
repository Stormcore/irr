...
Функционал: Недвижимость -> Дома, дачи. Аренда
  ...
  Сценарий: Фильтр по расположению
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Расположение" равно "Балашихинский"
  ...
  Сценарий: Фильтр по направлению шоссе
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Направление" равно "Казанское"
  ...
  Сценарий: Фильтр по шоссе
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Шоссе" равно "Егорьевское"
  ...
  Сценарий: Фильтр по удаленности
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Удаленность" >= "5"
       И в деталях каждого объявления "Удаленность" =< "30"
  ...
  Сценарий: Фильтр по году постройки/сдачи
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Год постройки/сдачи" >= "1933"
       И в деталях каждого объявления "Год постройки/сдачи" <= "2012"
  ...
  Сценарий: Фильтр по площади участка
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях каждого объявления "Площадь участка" <= "200"
  ...
  Сценарий: Фильтр по площади строения
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Площадь строения" >= "10"
       И в деталях каждого объявления "Площадь строения" <= "200"
  ...
  Сценарий: Фильтр по количеству комнат
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Количество комнат" >= "1"
       И в деталях каждого объявления "Количество комнат" <= "10"
  ...
  Сценарий: Фильтр по количеству спален
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Количество спален" >= "1"
       И в деталях каждого объявления "Количество спален" <= "10"
  ...
  Сценарий: Фильтр по материалу стен
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Материал стен" равно "деревянный"
  ...
  Сценарий: Фильтр по отапливаемости
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Отапливаемый"
  ...
  Сценарий: Фильтр по наличию гаража
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Гараж"
  ...
  Сценарий: Фильтр по телефону
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Телефон"
  ...
  Сценарий: Фильтр по наличию интернета
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Интернет"
  ...
  Сценарий: Фильтр по наличию мебели
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Мебель"
  ...
  Сценарий: Фильтр по наличию бытовой техники
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Бытовая техника"
  ...
  Сценарий: Фильтр по этажам в здании
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Этаж" >= "1"
       И в деталях каждого объявления "Этаж" <= "10"
  ...
  Сценарий: Фильтр по строению
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Строение" равно "дача"
