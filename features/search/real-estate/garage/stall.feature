# language:ru
Функционал: Недвижимость -> Гаражи и стоянки. Продажа -> Машиноместо

  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Недвижимость -> Гаражи и стоянки. Продажа -> Машиноместо"
