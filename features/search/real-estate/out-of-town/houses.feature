...
Функционал: Недвижимость -> Дома, дачи и участки. Продажа -> Дома, дачи
  ...
  Сценарий: Фильтр по площадь строения
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях каждого объявления "Площадь строения" <= "300"
  ...
  Сценарий: Фильтр по количеству этажей
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Количество этажей" >= "1"
       И в деталях каждого объявления "Количество этажей" <= "5"
  ...
  Сценарий: Фильтр по количеству комнат
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       ...
       И в деталях каждого объявления "Количество комнат" <= "5"
  ...
  Сценарий: Фильтр по газу в доме
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления присутствует "Газ в доме"
  ...
  Сценарий: Фильтр по материалу стен
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Материал стен" равно "кирпичный"
  ...
  Сценарий: Фильтр по ремонту
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Ремонт" равно "дом недостроен"
