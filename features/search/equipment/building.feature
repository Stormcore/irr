...
@customfield
  Сценарий: Фильтр по типу оборудования 1
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value                                 |
      | Тип оборудования | Строительное оборудование оборудование |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 2
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value                       |
      | Тип оборудования | Грузоподъемное оборудование |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 3
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value             |
      | Тип оборудования | Строительные леса |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 4
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value                    |
      | Тип оборудования | Строительные компрессоры |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 7
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value                                   |
      | Тип оборудования | Оборудование для приготовления раствора |
      И на странице поиска загружен список результатов
