...
@customfield
  Сценарий: Фильтр по типу оборудования 2
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value |
      | Тип оборудования | Системы охраны и безопасности |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 3
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value |
      | Тип оборудования | Оборудование для видеонаблюдения |
      И на странице поиска загружен список результатов
...
@customfield
  Сценарий: Фильтр по типу оборудования 4
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value |
      | Тип оборудования | Оборудование для охранной сигнализации |
      И на странице поиска загружен список результатов
