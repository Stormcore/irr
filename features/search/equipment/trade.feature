# language:ru
# encoding: utf-8
Функционал: Оборудование -> Для торговли и услуг

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Оборудование -> Для торговли и услуг"
...
@customfield
  Сценарий: Фильтр по типу оборудования 13
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value             |
      | Тип оборудования | Витрины, стеллажи |
      И на странице поиска загружен список результатов
