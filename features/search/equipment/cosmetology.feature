# language:ru
# encoding: utf-8
Функционал: Оборудование -> Косметологическое и медицинское

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Оборудование -> Косметологическое и медицинское"
...
@customfield
  Сценарий: Фильтр по типу оборудования
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип оборудования" равно "солярии"
