# language:ru
# encoding: utf-8
Функционал: Одежда, обувь, аксессуары -> Украшения, юверлирные изделия, бижутерия -> Ювелирные изделия

  Контекст:
    Когда открыта страница для региона "Россия"
        И на главной странице я перехожу в категорию "Одежда, обувь, аксессуары -> Украшения, юверлирные изделия, бижутерия -> Ювелирные изделия"
