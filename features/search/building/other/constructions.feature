...
Функционал: Строительство и ремонт -> Готовые конструкции: дома, бани, срубы
  ...
  Сценарий: Фильтр по "под ключ"
   Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления присуствует "Под ключ"

  Сценарий: Фильтр по ширине
    Когда я делаю поиск по следующим параметрам:
      | parameter  | min  | max    |
      | Ширина, мм | 100  | 100000 |
      И на странице поиска загружен список результатов
  ...
  Сценарий: Фильтр по длине
    Когда я делаю поиск по следующим параметрам:
      ...
      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Длина, мм" >= "100"
       И в деталях первого объявления "Длина, мм" <= "10000"
