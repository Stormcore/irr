...
Функционал: Авто и мото -> Автосервис и услуги -> Ремонт и сервис мототехники и других видов транспорта
  ...
  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Авто и мото -> Легковые автомобили -> Ремонт и сервис мототехники и других видов транспорта"
...
@wip
  Сценарий: Фильтр по ключевому слову
    Когда я ищу "мото"
       ...
       То на странице показано >= 1 объявлений
        И в каждом объявления содержится "мото"