...
Функционал: Авто и мото -> Автосервис и услуги -> Комиссионное оформление и страхование
  ...
  Контекст:
    Когда открыта страница для города "Москва"
        И на главной странице я перехожу в категорию "Авто и мото -> Легковые автомобили -> Комиссионное оформление и страхование"
...
@wip
  Сценарий: Фильтр по ключевому слову
    Когда я ищу "страховка"
       ...
       То на странице показано >= 1 объявлений
        И в каждом объявлении содержится "страховк"