...
Функционал: Авто и мото -> Коммерческий транспорт -> Спецтехника
  ...
  Сценарий: Фильтр по типу техники
   Когда открыта страница для города "Москва"
       И на главной странице я перехожу в категорию "Авто и мото -> Легковые автомобили -> Спецтехника" 
       И я делаю поиск по следующим параметрам:
      | parameter   | value     |
  ...
  Сценарий: Фильтр по марке и модели
   Когда открыта страница для города "Москва"
      ...
      То на странице показано >= 1 объявлений
       И в деталях каждого объявления "Марка" равно "Manitou"
       И в деталях каждого объявления "Модель" равно "MT1435SL"
