# language:ru
# encoding: utf-8
Функционал: Оборудование -> Производственно-техническое

  Контекст:
    Когда открыта страница для региона "Казахстан"
        И на главной странице я перехожу в категорию "Оборудование -> Производственно-техническое"
...
@customfield
  Сценарий: Фильтр по типу оборудования
   Когда я делаю поиск по следующим параметрам:
      | parameter        | value   |
      | Тип оборудования | швейное |
      И на странице поиска загружен список результатов

      То на странице показано >= 1 объявлений
       И в деталях первого объявления "Тип оборудования" равно "швейное"
