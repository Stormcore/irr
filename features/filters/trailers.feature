...
Функционал: Фильтр в Трейлерах

  Контекст:
    * открыта главная страница
    * открыт список объявлений для категории "Трейлеры"
  ...
  Сценарий: Марка - Schmitz
    Когда на странице фильтров я делаю поиск по параметрам:
      | поле  | значение |
      | Марка | Schmitz  |
       То на странице результатов показано >= 1 объявлений
        * в деталях каждого объявления на странице "Марка" равно "Schmitz"

  Сценарий: Модель - Schmitz SKO
    Когда на странице фильтров я делаю поиск по параметрам:
      | поле   | значение |
      | Марка  | Schmitz  |
      | Модель | SKO      |
  ...
  Сценарий: Тип прицепа - фургон
    Когда на странице фильтров я делаю поиск по параметрам:
      | поле        | значение |
      | Тип прицепа | Фургон   |
       То на странице результатов показано >= 1 объявлений
        * в деталях каждого объявления на странице "Тип прицепа" равно "Фургон"
