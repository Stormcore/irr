...
Функционал: Фильтр в Грузовиках

  Контекст:
    * открыта главная страница
    * открыт список объявлений для категории "Грузовики"
  ...
  Сценарий: Тип кузова - пикап
    Когда на странице фильтров я делаю поиск по параметрам:
      ...
      | Тип кузова | грузовик бортовой |
       То на странице результатов показано >= 1 объявлений
        * в деталях каждого объявления на странице "Тип кузова" равно "грузовик бортовой"
