...
@advert_submit
  Сценарий: Подача объявления для ОП через БО
    Когда я перехожу на БО
        ...
        * при создании объявления я перехожу на вкладку "Изображения" и загружаю картинку
     ...
     Когда открыта страница для региона "Актобе"
        ...
        * объявление с названием "Продаю Ауди" присутствует в списке
    ...
    Когда на странице оплаты я выбираю SMS
        ...
        * я вхожу под пользователем с ролью "Обычный пользователь"
        * я перехожу в список моих объявлений
       То объявление с названием "Продаю Ауди" присутствует в списке
